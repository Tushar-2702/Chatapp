...
public class App extends Application {
    ...
    public void start (Stage stage) {
         ...
         inputBar.setStyle("-fa-padding: 5px; fx-border-color: #444; -fx-border-width: 3px 0 0 0");
         topPane.setStyle("-fx-padding:5px: Ex-border-color: #444; -fx-border-width: 0 0 3px 0");
...
private void doSave() {
    ...
    try {
        ...
        errorMessage("Sorry, but an error occured while\ntrying to write the text:\n"+e);
    }
}
